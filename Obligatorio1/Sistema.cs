...
namespace Obligatorio1
{
    public class Sistema
    {
        ...
        private void Precarga()
        {
            ...
            Actividad ac11 = new ActividadTercerizada("Avatar 2", "Cine al aire libre", new DateTime(2023, 04, 15), 50, 1, 10, 50, false, new DateTime(2023, 04, 04), "DreamWorks S.R.L.");
            Actividad ac12 = new ActividadTercerizada("Super Mario Bros", "Cine al aire libre", new DateTime(2023, 04, 09), 50, 1, 10, 50, false, new DateTime(2023, 03, 26), "DreamWorks S.R.L.");
            Actividad ac13 = new ActividadTercerizada("Dick Tracy", "Cine al aire libre", new DateTime(2023, 06, 03), 50, 1, 10, 50, false, new DateTime(2023, 05, 28), "DreamWorks S.R.L.");
            Actividad ac14 = new ActividadTercerizada("Salto Bungee", "Salto desde el puente del Rio Negro", new DateTime(2023, 05, 29), 15, 21, 30, 5, true, new DateTime(2023, 04, 19), "Rekreation S.A.");
            Actividad ac15 = new ActividadTercerizada("Salto Bungee", "Salto desde el puente del Rio Negro", new DateTime(2023, 06, 23), 15, 21, 30, 15, false, new DateTime(2023, 06, 12), "Rekreation S.A.");
            Actividad ac16 = new ActividadTercerizada("Salto Bungee", "Salto desde el puente del Rio Negro", new DateTime(2023, 06, 15), 15, 21, 30, 15, false, new DateTime(2023, 05, 15), "Rekreation S.A.");
            Actividad ac17 = new ActividadTercerizada("NTVG", "Concierto", new DateTime(2023, 09, 13), 100, 1, 10, 65, true, new DateTime(2023, 08, 29), "TravelFun");
            Actividad ac18 = new ActividadTercerizada("Once Tiros", "Concierto", new DateTime(2023, 10, 25), 100, 1, 10, 50, false, new DateTime(2023, 07, 19), "TravelFun");
            Actividad ac19 = new ActividadTercerizada("Sordromo", "Concierto", new DateTime(2023, 05, 18), 100, 1, 10, 50, false, new DateTime(2023, 04, 06), "TravelFun");
            Actividad ac20 = new ActividadTercerizada("Pica-Pica", "Show musical infantil", new DateTime(2023, 06, 11), 50, 1, 10, 50, false, new DateTime(2023, 04, 09), "Electric Blue");
            Actividad ac21 = new ActividadTercerizada("Mago Daniel K", "Show de magia para ninios", new DateTime(2023, 07, 17), 50, 1, 10, 50, false, new DateTime(2023, 05, 26), "Electric Blue");
            Actividad ac22 = new ActividadTercerizada("Los Rokilis", "Show musical infantil", new DateTime(2023, 09, 13), 50, 1, 10, 50, true, new DateTime(2023, 06, 15), "Electric Blue");
